...
run_dir="${YOLO_RUN_DIR:-results/demo_correctness_${timestamp}}"
mkdir -p "$run_dir"
...
"${mpi[@]}" "${rank_cmd[@]}" | tee "$run_dir/demo_correctness.log"
...
echo "DEMO_CORRECTNESS_DIR=$run_dir"
